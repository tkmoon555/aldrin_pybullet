...
robot_pos = [0,0,1.1]
#print("***************************")#
robot_id = p.loadURDF("../../../config/models/blackbird_urdf/urdf/blackbird.urdf", robot_pos)#, flags = p.URDF_USE_INERTIA_FROM_FILE)
#print("***************************")#x
p.setPhysicsEngineParameter(numSolverIterations=10)
#p.changeDynamics(robot_id, -1, linearDamping=0, angularDamping=0)

p.setGravity(0, 0,-0.0)  # Set the gravity to -9.81 m/s^2 in the z-direction
